...
import { Button } from "@/components/ui/button"; // Asumsi dari shadcn/ui atau serupa
import { Input } from "@/components/ui/input";
import { Label } from "@/components/ui/label";
import { Checkbox } from "@/components/ui/checkbox"; // Untuk "Ingat Saya"
        ...
        <div className="bg-white p-8 rounded-xl shadow-2xl space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              {/* Saya kembalikan link Lupa Password di sini karena umum, sesuaikan jika tidak mau */}
            ...
            <div>
              <Button
                type="submit"
                className="w-full rounded-lg bg-black hover:bg-slate-500 text-white"
                disabled={isLoading}
              >
                {isLoading ? (
