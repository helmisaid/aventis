...
import { ChevronRight, CreditCard, Info, Lock, ShoppingBag } from "lucide-react"
            ...
            <div className="flex justify-between items-center mt-8">
              <div className="hidden md:flex w-full max-w-3xl mx-auto">
                <div className="w-1/3 text-center">
                  ...
                  <span className={`text-sm font-medium mt-2 block ${step >= 1 ? "text-black" : "text-gray-500"}`}>
                    Shipping
                  </span>
                </div>
                <div className="w-1/3 relative">
                  <div
                    className={`absolute top-5 left-0 right-0 h-0.5 ${step >= 2 ? "bg-black" : "bg-gray-200"}`}
                    style={{ zIndex: 0 }}
                  ></div>
                  <div
                  ...
                  <span className={`text-sm font-medium mt-2 block ${step >= 2 ? "text-black" : "text-gray-500"}`}>
                    Payment
                  </span>
                </div>
                <div className="w-1/3 relative">
                  <div
                    className={`absolute top-5 left-0 right-0 h-0.5 ${step >= 3 ? "bg-black" : "bg-gray-200"}`}
                  ></div>
                  <div
                    className={`h-10 w-10 rounded-full flex items-center justify-center mx-auto relative z-10 ${
                  ...
                  <span className={`text-sm font-medium mt-2 block ${step >= 3 ? "text-black" : "text-gray-500"}`}>
                    Confirmation
                  </span>
                </div>
              </div>
              ...
              <div className="lg:w-2/3">
                {step === 1 && (
                  <div className="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div className="space-y-4 mb-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <Input id="postalCode" placeholder="Enter postal code" className="mt-1" />
                        </div>
                        <div>
                    ...
                    >
                      <div className="flex items-center justify-between space-x-2 p-3 border rounded-lg border-gray-200">
                    ...
                    <div className="flex justify-between items-center mt-8">
                      ...
                      <Button className="bg-black hover:bg-gray-800" onClick={() => setStep(2)}>
                        Continue to Payment
                      </Button>
                    </div>
                  </div>
                ...
                {step === 2 && (
                  <div className="bg-white rounded-xl shadow-sm p-6">
                      ...
                      <TabsContent value="e-wallet">
                        <div className="space-y-4 mb-6">
                          <RadioGroup defaultValue="gopay" className="space-y-3">
                            <div className="flex items-center space-x-2 p-3 border rounded-lg border-gray-200">
                              <RadioGroupItem value="gopay" id="gopay" />
                              <Label htmlFor="gopay" className="font-medium flex items-center">
                                <Image
                            ...
                            <div className="flex items-center space-x-2 p-3 border rounded-lg border-gray-200">
                              ...
                              <Label htmlFor="ovo" className="font-medium flex items-center">
                                <Image
                            ...
                            <div className="flex items-center space-x-2 p-3 border rounded-lg border-gray-200">
                              ...
                              <Label htmlFor="dana" className="font-medium flex items-center">
                                <Image
                          ...
                          <div className="bg-gray-50 p-4 rounded-lg mt-4">
                            <p className="text-sm">
                              You will be redirected to the selected e-wallet platform to complete your payment after
                              placing your order.
                            </p>
                          </div>
                        </div>
                    ...
                    <div className="flex justify-between items-center mt-8">
                      <Button variant="outline" className="border-black hover:bg-gray-100" onClick={() => setStep(1)}>
                        Back to Shipping
                      </Button>
                      <Button className="bg-black hover:bg-gray-800" onClick={() => setStep(3)}>
                        Place Order
                      </Button>
                    </div>
                  </div>
                ...
                {step === 3 && (
                  <div className="bg-white rounded-xl shadow-sm p-6 text-center">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg mb-6">
                      <p className="font-medium mb-2">Order Number: #AVT-12345</p>
              ...
              <div className="lg:w-1/3">
                <div className="bg-white rounded-xl shadow-sm overflow-hidden sticky top-20">
                  <div className="p-6">
                    ...
                    <Accordion type="single" collapsible defaultValue="items" className="w-full mb-4">
