...
import { allProducts, formatPrice } from "../../data/products"; // Import allProducts
                    ...
                    <div className="p-6">
                      ...
                      <div className="space-y-6">
                        {cartItems.map((item) => (
                          ...
                          >
                            <div className="relative h-24 w-24 sm:h-32 sm:w-32 flex-shrink-0 rounded-md overflow-hidden border border-gray-200">
                              <Image
